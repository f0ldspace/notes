...
```
**Task**: Create a weekly journal summary for the 'self' folder (using obsidian)
...
- Additional context: `Changelog` file
...
## Monthly Summary
```
Turn my weekly summarys in obsidian (self/weekly/) for this month into a monthly summary file and save it in self/ format should be Month-year (e.g June-2025)
```
